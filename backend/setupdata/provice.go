...
func InsertProvinces(db *gorm.DB) {
	provinces := []string{
		...
		"Yasothon", "Chaiyaphum", "Amnat Charoen", "Bueng Kan",
		"Nong Bua Lam Phu", "Khon Kaen", "Udon Thani", "Loei", "Nong Khai",
		"Maha Sarakham", "Roi Et", "Kalasin", "Sakon Nakhon", "Nakhon Phanom", "Mukdahan",
		"Chiang Mai", "Lamphun", "Lampang", "Uttaradit", "Phrae", "Nan",
		"Phayao", "Chiang Rai", "Mae Hong Son",
		"Nakhon Sawan", "Uthai Thani", "Kamphaeng Phet", "Tak", "Sukhothai", "Phitsanulok",
		"Phichit", "Phetchabun",
		"Ratchaburi", "Kanchanaburi", "Suphan Buri", "Nakhon Pathom", "Samut Sakhon", "Samut Songkhram",
	...
	for _, name := range provinces {
		db.FirstOrCreate(&entity.Province{}, entity.Province{ProvinceName: name})
	}

	fmt.Println("Inserted Thai provinces successfully!")
}
